...
JavaScript (JS) is a high-level, lightweight, interpreted programming language used to make web pages dynamic, interactive, and responsive.
...
• Single-threaded (though asynchronous APIs and Web Workers help with concurrency)
• Client-side code is visible to users
• Browser compatibility issues may require polyfills/transpilation
• Dynamic typing can lead to runtime errors if not handled carefully
...
why function is variable?
A variable stores a value. In JavaScript, a function itself is a value (an object). So yes, a variable can store a function.
...
0
-0
0n,  BigInt version of the number 0
""
null
undefined
NaN
