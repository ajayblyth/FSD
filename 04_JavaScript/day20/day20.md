...
DEFINITION
--------------------------------------------------------------------------------
• JSON (JavaScript Object Notation) is a text-based data format used to represent 
  structured data and exchange it between client and server.
• Human-readable and easy for machines to parse.
• Commonly used in web APIs for sending and receiving data.
• Supports objects (key-value pairs), arrays, and primitive values.

NOTE
--------------------------------------------------------------------------------
• Convert JSON → JavaScript object using JSON.parse().
...
--------------------------------------------------------------------------------
• Data from server/API comes as JSON (text) → must convert to JS object to use in code.
• JavaScript works with objects, not JSON strings → need JSON.parse().
• To send/store data (API/localStorage), it must be in string format → need JSON.stringify().
• JSON = transport/storage format, JS object = usable format in program.
ADVANTAGES OF JSON
--------------------------------------------------------------------------------
