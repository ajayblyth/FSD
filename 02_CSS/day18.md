BOOTSTRAP NOTES - search getbootstrap.com and learn documentation.
===============
...
- Breakpoints:
  ...
  xl: ≥1200px
  xxl: ≥1400px
- Classes: .col-{breakpoint}-{columns}, .row, .container, .container-fluid
...
- Text: .lead, .small, .text-{color}, .text-center, .text-start, .text-end
- Utilities: .fw-bold, .fw-semibold, .fw-light, .fst-italic

6. COLORS
---------
- Text: .text-primary, .text-secondary, .text-success, .text-danger,
        .text-warning, .text-info, .text-light, .text-dark, .text-body
- Background: .bg-primary, .bg-secondary, .bg-success, .bg-danger, .bg-warning, .bg-info, .bg-light, .bg-dark, .bg-white

7. SPACING
----------
- Margin: .m-{t/r/b/l/x/y}-{0-5}
- Padding: .p-{t/r/b/l/x/y}-{0-5}
...
- Justify: .justify-content-start, .justify-content-center, .justify-content-end, .justify-content-between, .justify-content-around
- Align: .align-items-start, .align-items-center, .align-items-end, .align-items-baseline, .align-items-stretch
- Utilities: .align-self-start/center/end/stretch
...
- Navbar: .navbar, .navbar-expand-{sm/md/lg/xl}, .navbar-light/dark, .bg-light/dark
- Cards: .card, .card-body, .card-title, .card-text, .card-header, .card-footer
- Forms: .form-control, .form-label, .form-check, .form-check-input, .form-check-label, .form-select
...
- Badges: .badge, .bg-{color}, .rounded-pill
- List groups: .list-group, .list-group-item, .active, .disabled

10. UTILITIES
-------------
- Display: .d-{block/inline/inline-block/flex/grid/none}
- Visibility: .visible, .invisible
- Text: .text-{truncate, wrap, nowrap, center/start/end}
- Borders: .border, .border-{top/bottom/start/end}, .border-{0/1/2/3/4/5}, .rounded, .rounded-{circle, pill, 0, 1, 2, 3}
- Shadows: .shadow, .shadow-sm, .shadow-lg, .shadow-none
- Position: .position-static, .position-relative, .position-absolute, .position-fixed, .position-sticky, .top-0, .start-0, etc.
- Overflow: .overflow-auto, .overflow-hidden, .overflow-scroll

11. RESPONSIVE UTILITIES
-----------------------
- Show/hide: .d-none, .d-{sm/md/lg/xl/xxl}-block/inline/flex
- Text: .text-{sm/md/lg/xl/xxl}-start/center/end
...
13. ICONS
---------
- Use Bootstrap Icons (separate library)
- Include via CDN or npm
- Classes: <i class="bi bi-alarm"></i>

14. JAVASCRIPT COMPONENTS
-------------------------
- Carousel: .carousel, .carousel-inner, .carousel-item
- Collapse: .collapse, .collapse.show
- Tooltip: data-bs-toggle="tooltip", new bootstrap.Tooltip(element)
- Popover: data-bs-toggle="popover", new bootstrap.Popover(element)
- Toast: .toast, .toast-header, .toast-body
- Modal: data-bs-toggle="modal", .modal, JS API: bootstrap.Modal

15. TIPS
--------
- Mobile-first: apply base styles, then add breakpoints.
- Use utilities over custom CSS when possible.
- Combine classes for spacing, flex, text, etc., for rapid design.